...
<!-- SideBar Start -->
    ...
    <!-- Card Start -->
                <div>
                    ...
                    <div class="grid grid-cols-4 gap-10 p-10 pt-0">
    ...
    <!-- Card End -->
                ...
                <div class="max-h-fit bg-stone-500 col-span-4 p-7">
                    <div class="bg-white rounded-lg p-4">
                        ...
                        <hr>
                        <div class="mt-5">
                            <div class="bg-blue-700 flex px-5 rounded-lg">
                                <div class="p-2">
                                    <img class="rounded-t-lg w-20 h-20 rounded-lg" src="img/f1.jpg" alt="IMG" />
                                </div>
                                <div class="flex flex-col">
                                    <h1 class="text-white font-bold font-2xl">Pizza</h1>
                                    <div class="mt-4">
                                        <button class="bg-white rounded-full w-7 h-5">1</button>
                                           
                                        <button class="bg-white rounded-lg w-10 h-5 text-center">1</button>
