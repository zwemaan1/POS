...
@section('content')
        <div class="bg-bgPOS-100 w-screen ">
            ...
            <div class="grid grid-cols-12">
                ...
                <!-- Left Screen Start -->
                <div class="h-screen bg-bgPOS-100 col-span-8">
                    <!-- Filter Button Start -->
                    ...
                    <div class="flex justify-end mt-5 mr-10">
                       ...
                       <button type="button" class="bg-white shadow-lg text-black font-medium rounded-full text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-2 mb-2 hover:text-white hover:bg-blue-500 group">
                ...
                <!-- Card Start -->
                <div>
                    <div class="grid grid-cols-4 gap-10 p-5 overflow-y-auto">
                ...
                <!-- Card End -->
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="inline-flex mt-2 xs:mt-0">
                            ...
                            <button class="inline-flex items-center py-2 px-4 text-sm font-medium text-white bg-gray-800 rounded-l hover:bg-gray-900 dark:bg-gray-800">
                            ...
                            <button class="inline-flex items-center py-2 px-4 text-sm font-medium text-white bg-gray-800 rounded-r border-0 border-l border-gray-700 hover:bg-gray-900 dark:bg-gray-800">
                                Next
                ...
                <!-- Right Screen Start -->
                <div class="max-h-fit bg-stone-500 col-span-4 p-7">
                    <div class="bg-white rounded-lg p-4">
                        ...
                        <div class="mt-5">
                            <div class="bg-bluePOS-100 flex px-4 rounded-lg">
                                ...
                                <div class="border-y-4 border-x-2 border-y-white flex items-center"><span class="px-3 font-semibold text-white text-center w-20">$328.5</span></div>
                                <a href="#" class="relative">
                                    <svg class="w-10 h-10 absolute top-5 left-2 fill-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M310.6 361.4c12.5 12.5 12.5 32.75 0 45.25C304.4 412.9 296.2 416 288 416s-16.38-3.125-22.62-9.375L160 301.3L54.63 406.6C48.38 412.9 40.19 416 32 416S15.63 412.9 9.375 406.6c-12.5-12.5-12.5-32.75 0-45.25l105.4-105.4L9.375 150.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L160 210.8l105.4-105.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-105.4 105.4L310.6 361.4z"/></svg>
                                </a>
                            </div>
                        ...
                        <div class="mt-5">
                            <div class="bg-bluePOS-100 flex px-4 rounded-lg">
                                ...
                                <div class="border-y-4 border-x-2 border-y-white flex items-center"><span class="px-3 font-semibold text-white text-center w-20">$28.5</span></div>
                                <a href="#" class="relative">
                                    <svg class="w-10 h-10 absolute top-5 left-2 fill-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M310.6 361.4c12.5 12.5 12.5 32.75 0 45.25C304.4 412.9 296.2 416 288 416s-16.38-3.125-22.62-9.375L160 301.3L54.63 406.6C48.38 412.9 40.19 416 32 416S15.63 412.9 9.375 406.6c-12.5-12.5-12.5-32.75 0-45.25l105.4-105.4L9.375 150.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0L160 210.8l105.4-105.4c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25l-105.4 105.4L310.6 361.4z"/></svg>
                                </a>
                            </div>
                        ...
                        <hr class="h-1 bg-slate-600 mt-2">
